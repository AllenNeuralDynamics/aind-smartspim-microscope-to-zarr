...
from readers_writers import PngReader
...
def convert_stacks_to_ome_zarr(channel_path, logger, output_path, xyz_resolution):
...
def main():
    ...
    #    "SmartSPIM_702962_2024-05-15_23-10-40/SmartSPIM"
    #    #"SmartSPIM_721679_2024-07-03_12-38-54/SmartSPIM"
    # )

    channels = [channel.name for channel in list(BASE_PATH.glob("Ex_*_Em_*"))]
